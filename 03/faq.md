...
数据结构与算法非常重要 -> 它不依赖任何语言 -> 程序的灵魂 -> 做编程开始，你也许体会不到，但坐久了，你就会明白这点了

Java -> TreeMap 实现的源码非常非常好，非常优雅

源码 -> 你读懂了一个框架的源码，再去读另外一个的，就会轻松很多

老师的编程之路 -> 姐夫是搞电脑的、骇客 -> 高中就对编程感兴趣 -> 启蒙：比尔盖茨自传 -> 读到一句话 -> 形容比尔盖茨：他是我们不可估量的同类 -> 《了不起的盖茨比》这本书也不错

💡：程序就是位+上下文？

➹：[1.1 信息就是位+上下文 -《深入理解计算机系统》笔记](https://xxg1413.gitbooks.io/csapp/content/Chapter1/1.1.html)
